...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"rent-laptop","htmlAttrs":{"lang":"en"},"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_5919f89d === 'function') {
    await nuxt_plugin_plugin_5919f89d(app.context, inject)
  }
